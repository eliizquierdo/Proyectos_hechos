...
public class FrmEmpleado extends JFrame{
	...
	public FrmEmpleado() {
		...
		private void iniciarComponentes() {
			...
			panelEmpleado.add(txtCuotaBase);
			...
			chkEsVendedor = new JCheckBox("\u00BFEs becado?");
			...
			btnCalcular.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						int grupo=Integer.valueOf(txtNombre.getText());
						...
						if (chkEsVendedor.isSelected()) {
							...
							b=new Vendedor(saldoCuota,apellido,grupo,cuota,f);
							//System.out.println("becado: "+b.toString());
							txtCalcular.setText(String.valueOf(b.cuotaNeta()));
						}
						else {
							a=new Empleado(apellido,grupo,cuota,f);
