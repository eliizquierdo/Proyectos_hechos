...
public class EmpleadoDAO {
    ...
    // Métodos para obtener opciones del formulario
    public String[] getDepartamentos() {
        return new String[]{"sistemas", "ventas", "marketing", "rrhh", "finanzas", "operaciones"};
    }
    
    public String[] getIdiomas() {
        return new String[]{"español", "inglés", "francés", "alemán", "portugués", "italiano"};
    }
    
    /*
     * Los estudiantes pueden agregar más métodos para las opciones:
     * 
     * public String[] getCargos() {
     *     return new String[]{"practicante", "junior", "senior", "lead", "gerente"};
     * }
     * 
     * public String[] getHabilidades() {
     *     return new String[]{"java", "javascript", "python", "sql", "html", "css", "react"};
     * }
     */
}