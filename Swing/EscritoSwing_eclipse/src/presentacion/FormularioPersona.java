...
public class FormularioPersona extends JDialog {
	...
	private JPanel pnlSuperior, pnlInferior, pnlSexo;
	...
	private void iniciarComponentes() {
		...
		pnlInferior.setBounds(0, 253, 434, 55);
		...
		lblNombre.setBounds(61, 58, 70, 14);
		getContentPane().add(lblNombre);
		
		lblCiudad = new JLabel("Ciudad:");
		lblCiudad.setBounds(61, 87, 70, 14);
		...
		pnlSexo = new JPanel();
		pnlSexo.setBounds(74, 130, 93, 55);
