    ...
    <table class="table">
      ...
      %>
        <tr>
          ...
          <td><%= a.getGrupo() %></td>
          <td class="actions">
            <a class="btn btn-edit" href="<%= baseURL %>/alumno?action=cargarEditar&codigo=<%= a.getCodigo() %>">Editar</a>
            <form action="<%= baseURL %>/alumno?action=eliminar" method="post" style="display:inline;">
