...
public class InAgregarAlumno extends JInternalFrame {
	...
	private void iniciarComponentes() {
		...
		panel1.setBounds(10, 11, 236, 162);
		contentPane.add(panel1);
		panel1.setLayout(null);

		JLabel lblApellido = new JLabel("Apellido:");
		lblApellido.setBounds(10, 66, 96, 14);
		panel1.add(lblApellido);

		JLabel lblGrupo = new JLabel("Grupo:");
		lblGrupo.setBounds(10, 91, 96, 14);
		panel1.add(lblGrupo);

		JLabel lblCuotaBase = new JLabel("Cuota Base:");
		lblCuotaBase.setBounds(10, 116, 96, 14);
		panel1.add(lblCuotaBase);

		txtApellido = new JTextField();
		txtApellido.setBounds(116, 63, 110, 20);
		panel1.add(txtApellido);
		txtApellido.setColumns(10);

		txtGrupo = new JTextField();
		txtGrupo.setBounds(116, 88, 110, 20);
		panel1.add(txtGrupo);
		txtGrupo.setColumns(10);

		txtCuotaBase = new JTextField();
		txtCuotaBase.setBounds(116, 113, 110, 20);
		...
		txtCodigo.setBounds(116, 39, 110, 20);
		...
		btnLimpiar.setBounds(10, 186, 89, 23);
		contentPane.add(btnLimpiar);

		btnGuardar = new JButton("Guardar");
		btnGuardar.setBounds(140, 186, 89, 23);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (chkEsBecado.isSelected()) {
						...
						b = new Becado(codigo,saldoCuota, apellido, grupo, cuotaBase);
						txtCuotaNeta.setText(String.valueOf(b.cuotaNeta()));

					} else {
						a = new Alumno(codigo,apellido, grupo, cuotaBase);
