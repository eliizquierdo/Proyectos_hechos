...
import="modelo.vo.UsuarioVO" %> <% String baseURL = request.getContextPath();
UsuarioVO profesor = (UsuarioVO) request.getAttribute("Usuario"); %>
<!DOCTYPE html>
<html lang="es">
  <head>
    <meta charset="UTF-8" />
