...
public class Vehiculo implements Comparable<Vehiculo>{
    ...
    public int get_Anios() {
        ...
        int yearsDifference = f2.getYear() - f1.getYear();

        // Si la fecha actual todavía no ha alcanzado el mes y día de la fecha de matriculación
        // entonces restamos un año del resultado ya que el año no está completo.
        if (f2.getMonthValue() < f1.getMonthValue() || 
            (f2.getMonthValue() == f1.getMonthValue() && f2.getDayOfMonth() < f1.getDayOfMonth())) {
            yearsDifference--;
